...
<?php endif; ?>
		...
		<footer id="footer">
			...
			<div class="container">
				...
				printf( esc_html__( 'All Rights Reserved', 'ithemer' ), 'Maruf' );
			?></a>
			<span class="sep"> | </span>
			<?php
				/* translators: 1: Theme name, 2: Theme author. */
				printf( esc_html__( 'Developed by %s %2s.', 'Marufur Rahman' ), '', '<a href="https://www.facebook.com/profile.php?id=100008164664107/">&copy;Md.Marufur Rahman</a>' );
			?></p>
						</div>
						<!--/ End Copyright -->
					</div>
